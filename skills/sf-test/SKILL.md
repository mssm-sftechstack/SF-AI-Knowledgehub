...
name: sf-test
description: >
  Salesforce Apex test class generation and review skill. Enforces 90%+ coverage,
  bulk testing (200 records), positive/negative/edge case scenarios, SeeAllData=false,
  proper callout mocking, Mixed DML handling, and @TestVisible patterns. Based on
  Salesforce Apex Testing Guide (API 62.0).
allowed-tools: Bash(sf apex run test*), Bash(sf project deploy* --target-org <your-org-alias>*)
---
...
// Schedulable -- call execute() directly, never System.schedule() for callout-enabled schedulables
@IsTest
